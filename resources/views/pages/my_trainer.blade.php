                ...
                <div class="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl border border-gray-700 overflow-hidden shadow-lg">
                    ...
                    <div class="px-8 pb-8">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <a href="{{ route('auth.jadwal') }}" class="flex-1 px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white rounded-lg font-bold transition duration-300 shadow-md flex items-center justify-center gap-2">
